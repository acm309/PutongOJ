...
<template>
  <Menubar
    :model="menuItems"
    class="border border-(--p-content-border-color) border-t-0 border-x-0 fixed h-[62px] left-0 lg:px-10 md:px-8 mx-auto px-6 py-2 right-0 rounded-none shadow-lg top-0 z-50"
  >
