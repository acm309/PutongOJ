...
import type { DiscussionListQuery, DiscussionListQueryResult } from '@putong-oj/shared'
import { DiscussionListQuerySchema } from '@putong-oj/shared'
...
import { findProblemDiscussions } from '@/api/problem'
...
<template>
  <div class="p-0">
    ...
    <DiscussionDataView v-else :value="docs" :query="query" :hide-problem-tag="true" />
