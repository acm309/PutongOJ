...
import type { Paginated, PaginateOption } from 'src/types'
import type { ContestEntityEditable, ContestEntityPreview, ContestRanklist, SolutionEntity } from 'src/types/entity'
